...
class SessionModel
{
    ...
    {
        $sql = $this->conexion->query("INSERT INTO sesiones (usuario_id ,token ,fecha_hora_inicio, fecha_hora_fin ) VALUES ('$id_usuario','$token','$fecha_hora_inicio','$fecha_hora_fin')");
        if ($sql) {
